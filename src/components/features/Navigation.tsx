    ...
    <>
      ...
      <header className="bg-surface/70 dark:bg-surface/70 backdrop-blur-xl font-headline-sm text-headline-sm fixed top-0 w-full z-50 border-b border-white/10 shadow-[0_0_20px_rgba(0,243,255,0.1)]">
        <div className="flex justify-between items-center px-6 h-16 w-full">
          ...
          >
            <span className="font-mono text-sm uppercase">{isEn ? "PT" : "EN"}</span>
          </Link>
        </div>
      </header>
      ...
      <aside className="hidden md:flex flex-col h-[calc(100vh-64px)] w-72 rounded-r-xl bg-surface-container-low dark:bg-surface-container-low backdrop-blur-2xl border-r border-white/5 shadow-2xl fixed left-0 top-16 z-40 transition-all duration-200">
        ...
        <div className="p-6 border-b border-white/5 flex flex-col items-start gap-4">
          ...
          />
          <div>
            <h2 className="font-display-lg text-primary text-[20px] tracking-tight leading-tight">RODRIGO_BELARMINO</h2>
            <p className="font-code-sm text-code-sm text-on-surface-variant mt-1">Full-Stack Architect</p>
            <span className="inline-block mt-2 font-code-sm text-code-sm text-primary-container bg-primary-container/10 px-2 py-1 rounded">v2.4.0</span>
          </div>
        </div>
